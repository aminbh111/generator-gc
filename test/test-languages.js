...
describe('Greencode generator languages', function () {
    var languages = [
        ...
        describe('no social - creates ' + language.name, function () {
            ...
            it('contains 3 needles in global.json', function () {
                assert.fileContent(CLIENT_MAIN_SRC_DIR + 'i18n/' + language.value + '/global.json',
                    '"greencode-needle-menu-add-element": \"Greencode will add additional menu entries here (do not translate!)"');
                assert.fileContent(CLIENT_MAIN_SRC_DIR + 'i18n/' + language.value + '/global.json',
                    '"greencode-needle-menu-add-entry": "Greencode will add additional entities here (do not translate!)"');
                assert.fileContent(CLIENT_MAIN_SRC_DIR + 'i18n/' + language.value + '/global.json',
                    '"greencode-needle-menu-add-admin-element": "Greencode will add additional menu entries here (do not translate!)"');
            })
        });
    });
