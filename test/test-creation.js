...
const expectedFiles = {
    ...
    server: [
        ...
        SERVER_MAIN_SRC_DIR + 'com/mycompany/myapp/GreencodeApp.java',
    ...
    containerizeWithDocker: [
        DOCKER_DIR + 'greencode-registry.yml',
...
describe('Greencode generator', function () {
    ...
    describe('package names', function () {
        ...
        it('creates expected files with correct package names', function () {
            assert.file([
                SERVER_MAIN_SRC_DIR + 'com/otherpackage/GreencodeApp.java'
            ]);
            assert.fileContent(SERVER_MAIN_SRC_DIR + 'com/otherpackage/GreencodeApp.java', /package com\.otherpackage;/);
        });
    });
...
describe('Greencode server generator', function () {
...
describe('Greencode client generator', function () {
    this.timeout(4000); //to avoid occassional timeouts
