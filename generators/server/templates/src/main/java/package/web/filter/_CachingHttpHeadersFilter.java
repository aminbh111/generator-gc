...
public class CachingHttpHeadersFilter implements Filter {
    ...
    public CachingHttpHeadersFilter(GreencodeProperties greencodeProperties) {
        this.greencodeProperties = greencodeProperties;
    }

    @Override
    public void init(FilterConfig filterConfig) throws ServletException {
        CACHE_TIME_TO_LIVE = TimeUnit.DAYS.toMillis(greencodeProperties.getHttp().getCache().getTimeToLiveInDays());
    }
