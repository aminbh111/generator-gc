...
public class RateLimitingFilter extends ZuulFilter {
    ...
    public RateLimitingFilter(RateLimitingRepository rateLimitingRepository, GreencodeProperties greencodeProperties) {
        this.rateLimitingRepository = rateLimitingRepository;
        this.rateLimit = greencodeProperties.getGateway().getRateLimiting().getLimit();
    }
