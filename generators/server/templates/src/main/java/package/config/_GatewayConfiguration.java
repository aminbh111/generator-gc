...
public class GatewayConfiguration {
     ...
     * <li>A schema with the Greencode rate-limiting tables configured, using the
     ...
     */
    @Configuration
    @ConditionalOnProperty("greencode.gateway.rate-limiting.enabled")
    public static class RateLimitingConfiguration {
        ...
        public RateLimitingFilter rateLimitingFilter() {
            return new RateLimitingFilter(rateLimitingRepository(), greencodeProperties);
        }
    }
}
