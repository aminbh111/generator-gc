...
public class CustomPersistentRememberMeServices extends
    ...
    @Inject
    public CustomPersistentRememberMeServices(GreencodeProperties greencodeProperties, org.springframework.security.core.userdetails
        .UserDetailsService userDetailsService) {

        super(greencodeProperties.getSecurity().getRememberMe().getKey(), userDetailsService);
