...
var GreencodeServerGenerator = generators.Base.extend({});

util.inherits(GreencodeServerGenerator, scriptBase);
...
module.exports = GreencodeServerGenerator.extend({
    ...
    writing: {
        ...
        writeDockerFiles: function () {
            ...
            if (this.applicationType == 'microservice' || this.applicationType == 'gateway') {
                this.template(DOCKER_DIR + '_greencode-registry.yml', DOCKER_DIR + 'greencode-registry.yml', this, {});
            }
        ...
        writeServerJavaConfigFiles: function () {
            ...
            this.template(SERVER_MAIN_SRC_DIR + 'package/config/_GreencodeProperties.java', javaDir + 'config/GreencodeProperties.java', this, {});
            ...
            if (this.databaseType == 'cassandra') {
                ...
                this.template(SERVER_MAIN_SRC_DIR + 'package/config/metrics/_GreencodeHealthIndicatorConfiguration.java', javaDir + 'config/metrics/GreencodeHealthIndicatorConfiguration.java', this, {});
