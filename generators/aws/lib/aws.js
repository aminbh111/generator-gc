...
try {
    ...
    console.log(
        'You don\'t have the AWS SDK installed. Please install it in the Greencode generator directory.\n\n' +
        'WINDOWS\n' +
        'cd %USERPROFILE%\\AppData\\Roaming\\npm\\node_modules\\generator-greencode\n' +
        'npm install aws-sdk progress node-uuid\n\n' +
        'LINUX / MAC\n' +
        'cd /usr/local/lib/node_modules/generator-greencode\n' +
        'npm install aws-sdk progress node-uuid'
    );
    process.exit(e.code);
}
