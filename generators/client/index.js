...
var GreencodeClientGenerator = generators.Base.extend({});

util.inherits(GreencodeClientGenerator, scriptBase);
...
module.exports = GreencodeClientGenerator.extend({
