...
module.exports = yeoman.Base.extend({
    initializing: {
        sayHello: function() {
            this.log(chalk.white('Welcome to the Greencode Docker Compose Sub-Generator '));
        ...
        askForPath: function() {
                        ...
                        files.forEach(function(file) {
                            if(file.isDirectory()) {
                                if(shelljs.test('-f', file.name + '/.yo-rc.json')) {
                                    ...
                                    if(fileData['generator-greencode'].baseName !== undefined) {
            ...
            this.prompt(prompts, function (props) {
                ...
                for(var i = 0; i < this.appsFolders.length; i++) {
                    ...
                    var config = fileData['generator-greencode'];
                    if (config.applicationType === 'monolith' || this.appsFolders[i]==='greencode-registry' || this.appsFolders[i] === 'registry') {
    ...
    writing: {
        ...
        writeRegistryFiles: function() {
            ...
            this.copy('greencode-registry.yml', 'greencode-registry.yml');
